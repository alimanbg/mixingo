...
const staticFallback: Exercise[] = [
  {
    ...
    description: "Choose the correct article. Unlike vocabulary (where English helps), noun gender is new for all your languages.",
    question: "__ maison",
    options: ["le", "la"],
    correctIndex: 1,
    hint: "In French, most nouns ending in -aison are feminine. Maison (house) follows this pattern. English, Cantonese, and Mandarin don't have grammatical gender — this is a growth area.",
    hintLang: "For Cantonese, Mandarin & English speakers",
    aiMessage: "AI optimizing difficulty…",
  },
  {
    id: 2,
    Icon: BookOpen,
    title: "Cognate Goldmine",
    category: "Strong Foundation",
    categoryStyle: "bg-heat-green/10 text-heat-green border-heat-green/20",
    description: "~45% of English vocabulary has French origins. Match the cognate.",
    question: "important →",
    options: ["important", "cheval", "maison"],
    correctIndex: 0,
    hint: "Many -ant words are identical: différence/difference, classe/class, résultat/result. After 1066, French shaped English for 350 years — your English vocabulary is a power user's head start.",
    hintLang: "🇬🇧 English–French Cognate Goldmine",
    aiMessage: "Reinforcing vocabulary connections…",
  },
  {
    id: 3,
    Icon: Music,
    title: "Nasal Vowel: 人 → enfant",
    category: "Growth Opportunity",
    categoryStyle: "bg-heat-red/10 text-heat-red border-heat-red/20",
    description: "How is 'on' in 'bon' pronounced? Cantonese 人 uses similar nasal airflow.",
    question: "\"bon\" — what does 'on' sound like?",
    options: [
      "like 'own' in English",
      "nasal sound (air through nose + mouth)",
      "like 'on' in English",
      "silent",
    ],
    correctIndex: 1,
    hint: "🇨🇳 Cantonese 人 (lang) involves simultaneous oral and nasal airflow — very similar to French nasal vowels in 'enfant'. English has no equivalent. This is your Cantonese hidden advantage.",
    hintLang: "Cantonese → French nasal connection",
    audio: true,
